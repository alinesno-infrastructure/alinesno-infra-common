...
import com.alinesno.infra.common.security.api.annotation.ApiEncrypt;
...
public class CryptoFilter implements Filter {
        ...
        if (HttpMethod.PUT.matches(servletRequest.getMethod()) || HttpMethod.POST.matches(servletRequest.getMethod())) {
            ...
            if (StringUtils.isNotBlank(headerValue)) {
                ...
                if (ObjectUtil.isNotNull(apiEncrypt)) {
                    HandlerExceptionResolver exceptionResolver = SpringContext.getBean("handlerExceptionResolver", HandlerExceptionResolver.class);
    ...
    private ApiEncrypt getApiEncryptAnnotation(HttpServletRequest servletRequest) {
        RequestMappingHandlerMapping handlerMapping = SpringContext.getBean("requestMappingHandlerMapping", RequestMappingHandlerMapping.class);
        // 获取注解
        try {
