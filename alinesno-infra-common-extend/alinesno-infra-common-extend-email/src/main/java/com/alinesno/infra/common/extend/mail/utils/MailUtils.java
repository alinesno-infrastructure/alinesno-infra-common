package com.alinesno.infra.common.extend.mail.utils;
...
public class MailUtils {
    ...
    public static MailAccount getMailAccount(String from, String user, String pass) {
        ACCOUNT.setFrom(StringUtils.defaultIfBlank(from, ACCOUNT.getFrom()));
        ACCOUNT.setUser(StringUtils.defaultIfBlank(user, ACCOUNT.getUser()));
        ACCOUNT.setPass(StringUtils.defaultIfBlank(pass, ACCOUNT.getPass()));
        return ACCOUNT;
    }
