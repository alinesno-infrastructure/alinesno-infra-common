package com.alinesno.infra.common.extend.datasource.aspect;
...
public class DataPermissionQueryAdvice {
	...
	@Pointcut("@annotation(com.alinesno.infra.common.extend.datasource.annotation.DataPermissionQuery)")
