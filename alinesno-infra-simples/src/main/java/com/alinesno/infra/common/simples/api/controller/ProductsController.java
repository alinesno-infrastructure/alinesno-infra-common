...
@Api(tags = "Products")
@RestController
@RequestMapping("/api/infra/simple/crm/products")
public class ProductsController extends BaseController<ProductsEntity, IProductsService> {
    ...
    @Override
    public IProductsService getFeign() {
        return this.service;
    }
}
