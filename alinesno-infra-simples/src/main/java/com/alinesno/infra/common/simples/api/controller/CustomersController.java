...
/**
 * 处理与CustomersEntity相关的请求的Controller。
 *
 * @author luoxiaodong
 * @version 1.0.0
 */
...
@RequestMapping("/api/infra/simple/crm/Customers")
public class CustomersController extends BaseController<CustomersEntity, ICustomersService> {
    ...
    /**
     * 获取CustomersEntity的DataTables数据。
     *
    ...
    @Override
    public ICustomersService getFeign() {
        return this.service;
    }
}
